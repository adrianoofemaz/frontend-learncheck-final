...
const colorByTime = (v) => (v < 60 ? "bg-green-50" : v < 90 ? "bg-yellow-50" : "bg-red-50");
...
const DashboardModulPage = () => {
  ...
  // Back target ke Final Quiz Result
  const goBack = () => navigate(ROUTES.QUIZ_FINAL_RESULT);
  ...
  return (
    ...
    >
      <div className="py-4">
        <div className="max-w-6xl mx-auto px-0 space-y-6">
          <Card className="p-6">
